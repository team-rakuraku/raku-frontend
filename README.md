...
### **S3 + CloudFront 활용 미디어 데이터 캐싱 전략 적용**  
- **문제상황**<br/>미디어 데이터(이미지, 동영상) 요청이 증가하면서 S3에서 직접 데이터를 제공할 경우 응답 속도가 느려지고 비용이 증가했습니다. 또한, 동일한 파일이 반복 요청되며 네트워크 대역폭이 낭비되었습니다.  <br/><br/>
- **해결방법**<br/>CloudFront를 활용하여 CDN 레이어를 추가하고, TTL(Time To Live) 설정을 최적화하여 캐싱 효율을 극대화했습니다.<br/><br/>
- **내용정리 링크**  
  - [S3 + CloudFront 캐싱 전략](https://ssuojae.tistory.com/380)  
